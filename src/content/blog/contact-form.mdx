...
tag:
  ...
  - Docs
title: Contact Form
description: SisleyTech contact form, get your leads trough MailGun, Postmark or Slack!
...
SisleyTech contact form supports multiple topics, every topic can have their own destination email or slack channel. to open the contact dialog just create a link with `href="#contact"`
